...
class Tower:
    def __init__(self, x, y, tower_type):
        ...
        # Base Stats (Immutable unless leveled)
        ...
        # Working Stats (Calculated every frame or on change)
    ...
    def fire(self):
        ...
        # Create projectile with consistent tip color but effect-specific trail color
    ...
    def draw_design(cls, surface, cx, cy, type_name, color, angle, scale=1.0, is_shadow=False):
        # Extremely simplified, stylized geometric designs
        R = int(14 * scale)
